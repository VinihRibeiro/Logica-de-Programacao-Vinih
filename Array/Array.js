...
// Índices: Cada elemento em um array é acessado através de um índice numérico. O primeiro elemento está no índice 0, o segundo no índice 1 e assim por diante.

// Comprimento: O comprimento de um array é o número total de elementos contidos nele. Você pode acessar o comprimento de um array usando a propriedade length.

console.log(meuArray.length); // Exibe o comprimento do array

//Acesso a elementos: Você pode acessar elementos de um array usando seus índices. Por exemplo:

console.log(meuArray[0]); // Acessa o primeiro elemento
console.log(meuArray[2]); // Acessa o terceiro elemento
